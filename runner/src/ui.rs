...
use tui::{
    ...
    symbols::{self},
    text::{Span, Spans},
    widgets::{canvas::{Canvas, Line, Rectangle}, Dataset, Chart, Axis},
    ...
    B: Backend,
{
    ...
    let text = vec![
        Spans::from(vec![
            Span::styled("DTT:",Style::default().fg(Color::Red).add_modifier(Modifier::BOLD)),
            Span::from("\r"),
            Span::from(str_duration),
            Span::styled("ms\r",Style::default().fg(Color::Red).add_modifier(Modifier::BOLD)),
        ]),
        Spans::from(vec![
            Span::styled("MODE:",Style::default().fg(Color::LightBlue).add_modifier(Modifier::BOLD)),
            Span::from(app.mode_sent.to_string()),
        ]),
        Spans::from(vec![
            Span::styled("MTR:",Style::default().fg(Color::LightGreen).add_modifier(Modifier::BOLD)),
            Span::from("\r"),
        ...
        Spans::from(vec![
            Span::styled("YPR:",Style::default().fg(Color::LightMagenta).add_modifier(Modifier::BOLD)),
            Span::from("\r"),
        ...
        Spans::from(vec![
            Span::styled("YPR_Filter:",Style::default().fg(Color::LightRed).add_modifier(Modifier::BOLD)),
            Span::from("\r"),
        ...
        Spans::from(vec![
            Span::styled("ACC:",Style::default().fg(Color::Green).add_modifier(Modifier::BOLD)),
            Span::from("\r"),
        ...
        Spans::from(vec![
            Span::styled("BAT",Style::default().fg(Color::Blue).add_modifier(Modifier::BOLD)),
            Span::from("\r"),
            Span::from(app.batt.to_string()),
        ]),
        Spans::from(vec![
            Span::styled("BAR:",Style::default().fg(Color::Yellow).add_modifier(Modifier::BOLD)),
            Span::from("\r"),
    ...
    B: Backend,
{
    ...
    let block = Block::default().borders(Borders::RIGHT|Borders::LEFT|Borders::TOP).title(Span::styled(
        "Controls",
        Style::default()
            .fg(Color::Magenta)
            .add_modifier(Modifier::BOLD),
    ...
    B: Backend,
{
  ...
  let m1_str= (str_lift.parse::<f32>().unwrap()-str_pitch.parse::<f32>().unwrap()-str_yaw.parse::<f32>().unwrap()).to_string();
  let m2_str= (str_lift.parse::<f32>().unwrap()-str_roll.parse::<f32>().unwrap()+str_yaw.parse::<f32>().unwrap()).to_string();
  let m3_str= (str_lift.parse::<f32>().unwrap()+str_pitch.parse::<f32>().unwrap()-str_yaw.parse::<f32>().unwrap()).to_string();
  let m4_str= (str_lift.parse::<f32>().unwrap()+str_roll.parse::<f32>().unwrap()+str_yaw.parse::<f32>().unwrap()).to_string();
    let rows = vec![
    ...
    B: Backend,
{
        ...
        let b= [(0.0,app.ypr_filter[1].into()),(app.ypr_filter[2].into(),0.0)];
        let datasets = vec![
            Dataset::default()
                .name("dmp")
...
{
    let chunks = Layout::default()
        .constraints([Constraint::Min(20), Constraint::Min(40), Constraint::Min(20)])
        .direction(Direction::Vertical)
        .margin(1)
        .split(area);
    // draw_input_values(f, app, chunks[0]);
