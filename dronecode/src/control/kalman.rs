use crate::control::SensorData;
use crate::yaw_pitch_roll::YawPitchRoll;
use cordic::{atan, atan2};
...
use tudelft_quadrupel::fixed::types::{I16F16, I32F32};
...
impl LowPassOne
{
    ...
    pub fn low_pass_one(&mut self, gyro: [I16F16;3], acc: [I16F16;3])-> ([I16F16;3], [I16F16;3])    {
        // self.k =self.k +1;
        self.accel_x_in[0]= acc[0];
        self.accel_y_in[0]= acc[1];
        self.accel_z_in[0]= acc[2];
        ...
        self.accel_x_out[0]= self.a[0]*self.accel_x_out[1] + self.b[0]*self.accel_x_in[0] + self.b[1]* self.accel_x_in[1];
        self.accel_y_out[0]= self.a[0]*self.accel_y_out[1] + self.b[0]*self.accel_y_in[0] + self.b[1]* self.accel_y_in[1];
        self.accel_z_out[0]= self.a[0]*self.accel_z_out[1] + self.b[0]*self.accel_z_in[0] + self.b[1]* self.accel_z_in[1]   ;

        self.gyro_x_out[0]= self.a[0]*self.gyro_x_out[1] + self.b[0]*self.gyro_x_in[0] + self.b[1]* self.gyro_x_in[1];
        self.gyro_y_out[0]= self.a[0]*self.gyro_y_out[1] + self.b[0]*self.gyro_y_in[0] + self.b[1]* self.gyro_y_in[1];
        self.gyro_z_out[0]= self.a[0]*self.gyro_z_out[1] + self.b[0]*self.gyro_z_in[0] + self.b[1]* self.gyro_z_in[1];
...
pub struct KalmanFilter {
 ...
 impl KalmanFilter{
    ...
    pub fn get_kalman_data(&mut self, mut acc: [I16F16;3], gyro: [I16F16;3], sd:&SensorOffset)->YawPitchRoll {
        ...
        self.out_rate[0] = (gyro[2] + I16F16::from_num(sd.gyro_offset[2] as i16))*I16F16::from_num(PI/180);
        ...
        self.bias[1] = self.bias[1] + ((error_pitch*100) / self.c2);
        self.bias[2] = self.bias[2] + ((error_roll *100) / self.c2);
